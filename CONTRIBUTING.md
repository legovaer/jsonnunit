# JSONNUnit Contribution Guidelines

We like to encourage you to contribute to the JSONNUnit repository. This should
be as easy as possible for you but there are a few things to consider when
contributing. The following guidelines for contribution should be followed if
you want to submit a pull request or open an issue.
...
- Issue reports should be **clear**, **concise** and **reproducible**. Check to see if your issue has already been resolved in the [master]() branch or already reported in Chai's [GitHub Issue Tracker](https://github.com/legovaer/jsonnunit/issues).
- Pull Requests must adhere to strict [coding style guidelines](https://github.com/legovaer/jsonnunit/wiki/JSONNUnit-Coding-Style-Guide).
...
A good bug report shouldn't leave others needing to chase you up for more information. Please try to be as detailed as possible in your report. What is your environment? What steps will reproduce the issue? What JSONNET version and/or Node.js versions experience the problem? What would you expect to be the outcome? All these details will help people to fix any potential bugs.

Example:

> Short and descriptive example bug report title
>
> A summary of the issue and the JSONNET/OS environment in which it occurs. If suitable, include the steps required to reproduce the bug.
>
...
Please adhere to the coding conventions used throughout a project (indentation, accurate comments, etc.) and any other requirements (such as test coverage). Please review the [JSONNUnit Coding Style Guide](https://github.com/legovaer/jsonnunit/wiki/JSONNUnit-Coding-Style-Guide).
...
Anyone who is a core contributor (see the [Core Contributors Heading in the Readme](https://github.com/legovaer/jsonnunit#core-contributors)) can publish a release:

1. Go to the [Releases page on Github](https://github.com/legovaer/jsonnunit/releases)
...
- [JSONNUnit Coding Style Guide](https://github.com/legovaer/jsonnunit/wiki/JSONNUnit-Coding-Style-Guide)
...
- Levi Govaerts
  - GH: [@legovaer](https://github.com/legovaer)
  - TW: [@jakeluer](http://twitter.com/legovaer)
